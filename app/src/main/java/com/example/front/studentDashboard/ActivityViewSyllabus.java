...
public class ActivityViewSyllabus extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final StorageReference folderRef = storage.getReference().child("Btech/Syllabus/"+folderName);
        ...
        folderRef.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(com.google.firebase.storage.ListResult listResult) {
                for (StorageReference item : listResult.getItems()) {
                    ...
                    View cardView = LayoutInflater.from(ActivityViewSyllabus.this).inflate(R.layout.cardview_layout, containerLayout, false);
            ...
            public void onFailure(@NonNull Exception e) {
                // Handle any errors
                Toast.makeText(ActivityViewSyllabus.this, "Failed to list items in the folder", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void downloadFile(StorageReference folderRef, String fileName) {
        ...
        // Set up progress bar
        final ProgressBar progressBar = new ProgressBar(ActivityViewSyllabus.this, null, android.R.attr.progressBarStyleHorizontal);
        ...
        fileRef.getFile(localFile).addOnProgressListener(new OnProgressListener<FileDownloadTask.TaskSnapshot>() {
            ...
            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                ...
                try {
                    ...
                    Toast.makeText(ActivityViewSyllabus.this, "File downloaded successfully", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ActivityViewSyllabus.this, "Error moving file: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception exception) {
                // Handle any errors
                Toast.makeText(ActivityViewSyllabus.this, "Failed to download file: " + exception.getMessage(), Toast.LENGTH_SHORT).show();
