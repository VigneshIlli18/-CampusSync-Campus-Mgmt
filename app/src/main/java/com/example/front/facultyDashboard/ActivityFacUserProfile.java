...
public class ActivityFacUserProfile extends AppCompatActivity {
    FirebaseAuth fauth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fac_userprofile);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ActivityFacUserProfile.this, LoginActivity.class);
