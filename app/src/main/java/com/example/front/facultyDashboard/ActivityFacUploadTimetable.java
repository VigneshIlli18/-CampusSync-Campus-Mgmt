...
public class ActivityFacUploadTimetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fac_upload_timetable);

        // Set up AutoCompleteTextView with recommended subject names
        String[] recommendedSubjects = getResources().getStringArray(R.array.BranchANDSem); // Replace with your array resource
    ...
    private void uploadFile(String filename) {
        ...
        StorageReference subjectRef = storage.getReference().child("Btech/Timetables/" + subjectName + "/" + filename);
        ...
        subjectRef.putFile(fileUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(ActivityFacUploadTimetable.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(ActivityFacUploadTimetable.this, "Failed to upload file: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}