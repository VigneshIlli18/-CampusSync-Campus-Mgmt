...
public class ActivityFacUploadSyllabus extends AppCompatActivity {
    ...
    private void uploadFile(String filename) {
        ...
        StorageReference subjectRef = storage.getReference().child("Btech/Syllabus/" + subjectName + "/" + filename);
        ...
        subjectRef.putFile(fileUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(ActivityFacUploadSyllabus.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(ActivityFacUploadSyllabus.this, "Failed to upload file: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}