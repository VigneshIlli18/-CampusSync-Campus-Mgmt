...
public class ActivityFacUploadPrevPapers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fac_prevpap_upload);
    ...
    private void uploadFile(String filename) {
        ...
        StorageReference subjectRef = storage.getReference().child("Btech/PrevPapers/" + subjectName + "/" + filename);
        ...
        subjectRef.putFile(fileUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(ActivityFacUploadPrevPapers.this, "File uploaded successfully", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(ActivityFacUploadPrevPapers.this, "Failed to upload file: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}